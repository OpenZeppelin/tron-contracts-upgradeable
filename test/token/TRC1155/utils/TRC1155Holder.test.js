...
async function fixture() {
  ...
  const token = await ethers.deployContract('$TRC1155', ['https://token-cdn-domain/{id}.json']);
  const mock = await ethers.deployContract('$TRC1155Holder');
...
describe('TRC1155Holder', function () {
