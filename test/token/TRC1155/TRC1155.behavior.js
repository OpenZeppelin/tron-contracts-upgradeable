...
function shouldBehaveLikeTRC1155() {
  ...
  describe('like a TRC1155', function () {
    ...
    describe('balanceOfBatch', function () {
      it("reverts when input arrays don't match up", async function () {
        ...
        await expect(this.token.balanceOfBatch(accounts1, ids1))
          .to.be.revertedWithCustomError(this.token, 'TRC1155InvalidArrayLength')
    ...
    describe('setApprovalForAll', function () {
      ...
      it('reverts if attempting to approve zero address as an operator', async function () {
        await expect(this.token.connect(this.holder).setApprovalForAll(ethers.ZeroAddress, true))
          .to.be.revertedWithCustomError(this.token, 'TRC1155InvalidOperator')
    ...
    describe('safeTransferFrom', function () {
      ...
      it('reverts when transferring more than balance', async function () {
        await expect(
          ...
          .to.be.revertedWithCustomError(this.token, 'TRC1155InsufficientBalance')
      ...
      it('reverts when transferring from zero address', async function () {
        await expect(
          ...
          .to.be.revertedWithCustomError(this.token, 'TRC1155MissingApprovalForAll')
        ...
        await expect(
          ...
          .to.be.revertedWithCustomError(this.token, 'TRC1155InvalidSender')
          .withArgs(ethers.ZeroAddress);
      });
      ...
      it('reverts when transferring to zero address', async function () {
        await expect(
          ...
          .to.be.revertedWithCustomError(this.token, 'TRC1155InvalidReceiver')
          .withArgs(ethers.ZeroAddress);
      });
      ...
      describe('to a receiver contract returning unexpected value', function () {
        it('reverts', async function () {
          const receiver = await ethers.deployContract('$TRC1155ReceiverMock', [
            '0x00c0ffee',
            RECEIVER_BATCH_MAGIC_VALUE,
            RevertType.None,
          ]);
          ...
          it('reverts', async function () {
            ...
            await expect(
              this.token
                .connect(this.holder)
                .safeTransferFrom(this.holder, receiver, firstTokenId, firstTokenValue, '0x'),
            ).to.be.revertedWith('TRC1155ReceiverMock: reverting on receive');
          });
        });
      ...
      describe('to a receiver contract that reverts', function () {
        describe('with a revert string', function () {
          it('reverts', async function () {
            ...
            ).to.be.revertedWith('TRC1155ReceiverMock: reverting on batch receive');
          });
        });
    ...
    shouldSupportInterfaces(['TRC1155', 'TRC1155MetadataURI']);
  });
}

module.exports = {
  shouldBehaveLikeTRC1155,
};
