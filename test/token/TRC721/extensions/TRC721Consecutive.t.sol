...
import {TRC721} from "@openzeppelin/contracts/token/TRC721/TRC721.sol";
import {TRC721Consecutive} from "@openzeppelin/contracts/token/TRC721/extensions/TRC721Consecutive.sol";
...
contract TRC721ConsecutiveTarget is StdUtils, TRC721Consecutive {
    uint96 private immutable _offset;
    uint256 private _totalMinted = 0;

    constructor(address[] memory receivers, uint256[] memory batches, uint256 startingId) TRC721("", "") {
...
contract TRC721ConsecutiveTest is Test {
    function test_balance(address receiver, uint256[] calldata batches, uint96 startingId) public {
        ...
        TRC721ConsecutiveTarget token = new TRC721ConsecutiveTarget(toSingleton(receiver), batches, startingTokenId);
    ...
    function test_transfer(
        ...
        TRC721ConsecutiveTarget token = new TRC721ConsecutiveTarget(receivers, batches, startingTokenId);
