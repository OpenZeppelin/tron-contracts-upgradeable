...
async function fixture() {
  ...
  const receiver = await ethers.deployContract('$TRC7786RecipientMock', [gateway]);
...
describe('TRC7786Recipient', function () {
  ...
  it('unauthorized call', async function () {
    await expect(
      ...
      .to.be.revertedWithCustomError(this.receiver, 'TRC7786RecipientUnauthorizedGateway')
