...
Here's a simple example of using `AccessControl` in an xref:trc20.adoc[TRC-20 token] to define a 'minter' role, which allows accounts that have it to create new tokens:

[source,solidity]
----
include::api:example$access-control/AccessControlTRC20MintBase.sol[]
----
...
[source,solidity]
----
include::api:example$access-control/AccessControlTRC20MintOnlyRole.sol[]
----
...
[source,solidity]
----
include::api:example$access-control/AccessControlTRC20MintMissing.sol[]
----
...
Here's a simple example of an xref:tokens.adoc#TRC20[TRC-20 token] that defines a `mint` function that is restricted by an xref:api:access.adoc#AccessManager[`AccessManager`]:

```solidity
include::api:example$access-control/AccessManagedTRC20MintBase.sol[]
```
