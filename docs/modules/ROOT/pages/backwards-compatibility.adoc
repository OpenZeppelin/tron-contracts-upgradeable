...
We recommend using the Tron Upgrades plugins — https://github.com/OpenZeppelin/tron-upgrades[`@openzeppelin/hardhat-tron-upgrades` and `@openzeppelin/tronbox-upgrades`], or https://github.com/OpenZeppelin/openzeppelin-foundry-upgrades-tron[`@openzeppelin/foundry-upgrades-tron`] for Foundry — to ensure storage layout safety of upgrades.
