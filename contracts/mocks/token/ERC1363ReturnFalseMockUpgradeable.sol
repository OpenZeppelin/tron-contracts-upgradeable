...
abstract contract ERC1363ReturnFalseOnTRC20MockUpgradeable is Initializable, ERC1363Upgradeable {
    ...
    function transfer(address, uint256) public pure override(ITRC20Upgradeable, TRC20Upgradeable) returns (bool) {
        return false;
    }

    function transferFrom(address, address, uint256) public pure override(ITRC20Upgradeable, TRC20Upgradeable) returns (bool) {
        return false;
    }

    function approve(address, uint256) public pure override(ITRC20Upgradeable, TRC20Upgradeable) returns (bool) {
        return false;
    }
}
