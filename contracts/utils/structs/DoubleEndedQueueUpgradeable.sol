...
library DoubleEndedQueueUpgradeable {
    ...
    function pushBack(Bytes32Deque storage deque, bytes32 value) internal {
        ...
        if (!success) PanicUpgradeable.panic(PanicUpgradeable.RESOURCE_ERROR);
    }
    ...
    function popBack(Bytes32Deque storage deque) internal returns (bytes32) {
        ...
        if (!success) PanicUpgradeable.panic(PanicUpgradeable.EMPTY_ARRAY_POP);
        return value;
    }
    ...
    function front(Bytes32Deque storage deque) internal view returns (bytes32) {
        ...
        if (!success) PanicUpgradeable.panic(PanicUpgradeable.ARRAY_OUT_OF_BOUNDS);
        return value;
    }
