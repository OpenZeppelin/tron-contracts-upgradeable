 ...
 * @custom:stateless
 */
abstract contract AbstractSignerUpgradeable is Initializable {
    function __AbstractSigner_init() internal onlyInitializing {
    }

    function __AbstractSigner_init_unchained() internal onlyInitializing {
    }
    /**
