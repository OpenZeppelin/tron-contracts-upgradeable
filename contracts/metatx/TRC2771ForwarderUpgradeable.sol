 ...
 */
contract TRC2771ForwarderUpgradeable is Initializable, TIP712Upgradeable, NoncesUpgradeable {
     ...
     */
    function __TRC2771Forwarder_init(string memory name) internal onlyInitializing {
        __TIP712_init_unchained(name, "1");
    }

    function __TRC2771Forwarder_init_unchained(string memory) internal onlyInitializing {}
    ...
    function _isTrustedByTarget(address target) internal view virtual returns (bool) {
        bytes memory encodedParams = abi.encodeCall(TRC2771ContextUpgradeable.isTrustedForwarder, (address(this)));
