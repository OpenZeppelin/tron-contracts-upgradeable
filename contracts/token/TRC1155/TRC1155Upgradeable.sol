    ...
    ITRC1155Errors
{
     ...
     * @dev See {_setURI}.
     */
    function __TRC1155_init(string memory uri_) internal onlyInitializing {
        __TRC1155_init_unchained(uri_);
    }

    function __TRC1155_init_unchained(string memory uri_) internal onlyInitializing {
        _setURI(uri_);
    }
