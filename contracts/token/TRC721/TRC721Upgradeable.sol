    ...
    ITRC721Errors
{
    ...
    // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.TRC721")) - 1)) & ~bytes32(uint256(0xff))
    bytes32 private constant TRC721StorageLocation = 0x19fa630e948fbb0ab622912acfd1586d02915ad9213a0affefc75ceafe776900;

    function _getTRC721Storage() private pure returns (TRC721Storage storage $) {
        assembly {
            $.slot := TRC721StorageLocation
        }
    }
     ...
     */
    function __TRC721_init(string memory name_, string memory symbol_) internal onlyInitializing {
        __TRC721_init_unchained(name_, symbol_);
    }

    function __TRC721_init_unchained(string memory name_, string memory symbol_) internal onlyInitializing {
