 ...
 */
abstract contract TRC721ConsecutiveUpgradeable is Initializable, IERC2309Upgradeable, TRC721Upgradeable {
    using BitMapsUpgradeable for BitMapsUpgradeable.BitMap;
    using CheckpointsUpgradeable for CheckpointsUpgradeable.Trace160;

    /// @custom:storage-location erc7201:openzeppelin.storage.TRC721Consecutive
    struct TRC721ConsecutiveStorage {
    ...
    function _getTRC721ConsecutiveStorage() private pure returns (TRC721ConsecutiveStorage storage $) {
        assembly {
            $.slot := TRC721ConsecutiveStorageLocation
        }
    }
