...
abstract contract TRC20Upgradeable is Initializable, ContextUpgradeable, ITRC20Upgradeable, ITRC20MetadataUpgradeable, ITRC20ErrorsUpgradeable {
    ...
    // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.TRC20")) - 1)) & ~bytes32(uint256(0xff))
    bytes32 private constant TRC20StorageLocation = 0xe1a24297b3533be8944ab78b84526ae6f690150498d54c0651d0fdaf453c4100;

    function _getTRC20Storage() private pure returns (TRC20Storage storage $) {
        assembly {
            $.slot := TRC20StorageLocation
        }
    }
