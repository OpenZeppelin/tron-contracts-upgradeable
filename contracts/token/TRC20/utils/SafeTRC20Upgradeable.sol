...
library SafeTRC20Upgradeable {
     ...
     */
    function safeTransfer(ITRC20Upgradeable token, address to, uint256 value) internal {
     ...
     */
    function safeTransferFrom(ITRC20Upgradeable token, address from, address to, uint256 value) internal {
     ...
     */
    function trySafeTransfer(ITRC20Upgradeable token, address to, uint256 value) internal returns (bool) {
     ...
     */
    function trySafeTransferFrom(ITRC20Upgradeable token, address from, address to, uint256 value) internal returns (bool) {
     ...
     */
    function safeIncreaseAllowance(ITRC20Upgradeable token, address spender, uint256 value) internal {
     ...
     * that has a non-zero temporary allowance (for that particular owner-spender) will result in unexpected behavior.
     */
    function safeDecreaseAllowance(ITRC20Upgradeable token, address spender, uint256 requestedDecrease) internal {
        unchecked {
     ...
     * set here.
     */
    function forceApprove(ITRC20Upgradeable token, address spender, uint256 value) internal {
     ...
     */
    function transferAndCallRelaxed(IERC1363Upgradeable token, address to, uint256 value, bytes memory data) internal {
        if (to.code.length == 0) {
     ...
     * Reverts if the returned value is other than `true`.
     */
    function approveAndCallRelaxed(IERC1363Upgradeable token, address to, uint256 value, bytes memory data) internal {
        if (to.code.length == 0) {
     ...
     */
    function _safeTransfer(ITRC20Upgradeable token, address to, uint256 value, bool bubble) private returns (bool success) {
        bytes4 selector = ITRC20Upgradeable.transfer.selector;
    ...
    function _safeTransferFrom(
        ITRC20Upgradeable token,
        address from,
        address to,
        uint256 value,
        bool bubble
    ) private returns (bool success) {
        bytes4 selector = ITRC20Upgradeable.transferFrom.selector;
     ...
     * @param bubble Behavior switch if the transfer call reverts: bubble the revert reason or return a false boolean.
     */
    function _safeApprove(ITRC20Upgradeable token, address spender, uint256 value, bool bubble) private returns (bool success) {
        bytes4 selector = ITRC20Upgradeable.approve.selector;
