...
* {BridgeFungible}: Core bridging logic for crosschain TRC-20 transfer. Used by {BridgeERC20}, {BridgeERC7802} and {TRC20Crosschain},
* {BridgeERC20}: Standalone bridge contract to connect a TRC-20 token contract with counterparts on remote chains,
